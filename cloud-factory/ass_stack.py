...
"""Java application CloudFormation template generator.

Usage:
    ass_stack.py [-v] -f CONFIGURATION_FILE ENV
...
def create_launch_config(aws_config, config, instance_type, zones, security_groups, env):
...
if __name__ == '__main__':
    ...
    launch_config = create_launch_config(aws_config, config, instance_type, zones, [cluster_security_group], env)
